...
setwd(here::here())
theta <- readRDS("self_theta_01_INDEP_nnbs.Rda")[,sample_idx]
theta_s <- readRDS("self_theta_10_INDEP_nnbs.Rda")[,sample_idx]
S <- nrow(y)
...
saveRDS(weekly_ini_INDEP, "weekly_ini_INDEP_nnbs.Rda")
saveRDS(weekly_final_INDEP, "weekly_final_INDEP_nnbs.Rda")
