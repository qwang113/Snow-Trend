...
theta_E1_all <- theta[(8*S+1):(9*S),]
theta_E2_all <- theta[(9*S+1):(10*S),]
theta_L1_all <- theta[(10*S+1):(11*S),]
theta_L2_all <- theta[(11*S+1):(12*S),]
...
theta_E1s_all <- theta_s[(8*S+1):(9*S),]
theta_E2s_all <- theta_s[(9*S+1):(10*S),]
theta_L1s_all <- theta_s[(10*S+1):(11*S),]
theta_L2s_all <- theta_s[(11*S+1):(12*S),]
